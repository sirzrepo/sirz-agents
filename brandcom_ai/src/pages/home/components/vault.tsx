...
export default function Vault() {
    return (
        <section className="px-6 py-16 sm:w-[80%] w-[90%] mx-auto flex flex-col items-center">
            ...
            <p className="text-xl text-gray-600 md:w-[40%] mx-auto text-center">Keep all your brand visuals, files, and content assets organized, accessible, and beautifully managed in a single dashboard.</p>
